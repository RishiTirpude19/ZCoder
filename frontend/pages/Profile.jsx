...
import { User, Mail, Code2, Star, Github, Globe, Bookmark, Briefcase, ArrowLeft, Loader2, Crown, Users } from "lucide-react";
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-center">
              <div className="inline-flex items-center gap-3 bg-blue-600/20 border border-blue-500/30 rounded-full px-6 py-2 mb-4">
                ...
                <span className="text-blue-400 font-medium">User Profile</span>
              </div>
              ...
              <p className="text-slate-400">View and manage user information</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6">
                ...
                {user.projectslinks && user.projectslinks.length > 0 ? (
                  ...
                  <p className="text-slate-400">No projects linked yet.</p>
                )}
              </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6">
                ...
                {user.otherBookMarkedProblems && user.otherBookMarkedProblems.length > 0 ? (
                  ...
                  <p className="text-slate-400">No bookmarked problems yet.</p>
                )}
              </div>
            </div>
          </div>
