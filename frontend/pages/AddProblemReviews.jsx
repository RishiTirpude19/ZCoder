          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold text-white mb-2">
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Problem Review</span>
              </h1>
              <p className="text-slate-400">Share your feedback and rating for this problem</p>
            </div>
