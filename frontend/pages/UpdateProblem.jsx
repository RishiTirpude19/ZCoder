...
function UpdateProblem() {
    ...
    useEffect(() => {
        const fetchProblemDetails = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`https://z-coder.vercel.app/problem/${problemId}`, {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://z-coder.vercel.app/problem/${problemId}/updateproblem`, formData, {
                withCredentials: true,
            });
