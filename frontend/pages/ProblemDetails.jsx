...
function ProblemDetail() {
    ...
    useEffect(() => {   
        async function fetchProblem() {
            try {
                const response = await axios.get(`https://z-coder.vercel.app/problem/${problemId}`, {withCredentials: true});
    ...
    async function handleBookmark() {
        try {
            if (isBookmarked) {
                const response = await axios.post(`https://z-coder.vercel.app/unbookmark/${problemId}`, {}, { withCredentials: true });
                console.log("Removed from bookmark:", response);
            } else {
                const response = await axios.post(`https://z-coder.vercel.app/bookmark/${problemId}`, {}, { withCredentials: true });
        ...
        <>
            ...
            <div className='update'>
                ...
                <button onClick={async () => {
                    axios.delete(`https://z-coder.vercel.app/problem/${problemId}/deleteproblem`, { withCredentials: true });
                    console.log("Deleted");
                    navigate(`/dashboard`);
